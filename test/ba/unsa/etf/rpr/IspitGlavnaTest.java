...
public class IspitGlavnaTest {
    ...
    @Test
    public void testDodajKraljevskuDrzavu(FxRobot robot) {
        ...
        assertNotNull(bih);
        assertEquals(true, bih.isKraljevska());
    }

    @Test
    public void testDodajKraljevskiGrad(FxRobot robot) {
        // Najprije dodajemo kraljevsku državu
        robot.clickOn("#btnDodajDrzavu");
        ...
        assertTrue(sarajevo.isKraljevski());
        ...
        // Checkbox je označen
        CheckBox cbOlimpijski = robot.lookup("#cbKraljevski").queryAs(CheckBox.class);
        assertTrue(cbOlimpijski.isSelected());
    }

    @Test
    public void testDodajGradNijeKraljevska(FxRobot robot) {
        // Probaćemo dodati kraljevski grad u državu koja nije kraljevska
        robot.clickOn("#btnDodajGrad");
        ...
        assertNotNull(dialogPane.lookupAll("Država Austrija nije kraljevska država"));

        // Klik na dugme Ok
        Button okButton = (Button) dialogPane.lookupButton(ButtonType.OK);
        robot.clickOn(okButton);

        // Označavamo da ipak nije kraljevski
        robot.clickOn("#cbKraljevski");
        robot.clickOn("#btnOk");

        // Da li se grad dodao u bazu?
        Grad innsbruck = dao.nadjiGrad("Innsbruck");
        assertFalse(innsbruck.isKraljevski());
        ...
        assertFalse(cbKraljevski.isSelected());
    }
}